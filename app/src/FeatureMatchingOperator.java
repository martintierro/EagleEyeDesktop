...
//    private DescriptorExtractor descriptorExtractor = DescriptorExtractor.create(DescriptorExtractor.ORB);
    ...
    private void detectFeaturesInReference() {
        ...
        Feature2D feature2D = ORB.create();

        detector.detect(this.referenceMat, this.refKeypoint);
        feature2D.compute(this.referenceMat, this.refKeypoint, this.referenceDescriptor);
    }
    ...
    private class FeatureMatcher extends FlaggingThread {
        ...
        private Feature2D feature2D = ORB.create();
...
//        private DescriptorExtractor descriptorExtractor = DescriptorExtractor.create(DescriptorExtractor.ORB);
        ...
        public void run() {
            ...
            this.detector.detect(this.comparingMat,this.keypoint);
            this.feature2D.compute(this.comparingMat, this.keypoint, this.descriptor);
